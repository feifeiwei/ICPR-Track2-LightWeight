...
Fa = 1.92604065e-05 #虚警率 False alarm rate
Pd = 0.42073229   #检测率 Detection rate
IoU = 0.55265  #平均交并比 average intersection over union
Params = 0.038489 #模型参数量 M Parameters of your model (Unit: M)
Flops = 0.391999 #模型运算量 GFlops of your model
